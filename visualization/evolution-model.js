...
(function (root) {
  ...
  const chapters = [
    ...
    { at: 110, name: 'Green Space', subtitle: 'Life takes form', color: '#69dbac', title: 'The same motion becomes life.', description: 'Cooling matter gathers into chains and living structures. Information takes a biological form, while the Blue fabric beneath it continues to break symmetry. Nothing beneath life stops breathing.', motifs: 'COOLING MATTER · LIVING CHAINS · CONTINUOUS BREATH' },
    ...
    { at: 150, name: 'Orange Space', subtitle: 'A new conversation', color: '#ff9c68', title: 'The pattern becomes a computer.', description: 'Constructed matter finds another arrangement: circuits and computation. Orange signals reach toward the Blue fabric. The universe keeps breathing through every space at once.', motifs: 'CIRCUITS · INFORMATION · ORANGE REACHES TOWARD BLUE' }
  ];
  ...
  function state(t) {
    ...
    return {
      ...
      life: ramp(t, 110, 131), tools: ramp(t, 132, 149),
      computing: ramp(t, 150, 168), breath: 1 + .045 * Math.sin(t * 1.2)
    };
  }
  ...
  const api = { chapters, clamp, ramp, state, receivedCount, twirlRadius, duration: 168 };
