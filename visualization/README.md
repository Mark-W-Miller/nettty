...
- From the first breath restarts the film. At 2:56 the completed scene keeps breathing until paused.
...
| 1:50 | Green: Earth resolves into oceans, land, and atmosphere; from 1:58, living chains form as the globe recedes |
| 2:12 | Yellow: some of those particles move into constructed hive cells; life remains |
| 2:30 | Orange: another subset becomes circuitry, with only hints of the earlier spaces; from 2:38 the rigid grid opens into a flowing thoughtnet |
