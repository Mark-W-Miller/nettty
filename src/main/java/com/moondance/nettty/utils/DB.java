...
public class DB {
    public static boolean DB_OCTREE_DUMP = false;
    public static boolean DB_OCTNODE = true;
    public static boolean DB_OCTWALK = true;
    ...
    public static boolean DB_NETTYAPP_ORBIT = false;
    public static boolean DB_WRITE_RULE = true;
    public static boolean DB_WRITE_RULE_TRACE = false;
    public static boolean DB_RULE = true;
